    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title  pt-3 pb-3"><?= !empty($crop) ? "Edit" : "Create" ?> Crop</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-4 col-md-12">
                        ...
                        <button type="button" class="btn btn-sm btn-primary btn-labeled" id="addMore"><span class="me-1"><i class="ti ti-plus btn-label"></i></span>Add variable</button>
                    </div>
                </div>
