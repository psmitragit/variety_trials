...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Manage Uploads</h4>
                <div>
                        ...
                        <tbody>
                            <?php foreach ($uploads as $k => $l) : ?>
                                <tr>
                                    ...
                                    <td><?= $l['state_code'] ?></td>
                                    <td>
                                        <a class="text-decoration-none" href="<?= base_url($l['url']) ?>" target="_blank"><i class="ti ti-eye" title="View PDF"></i></a>&ensp;
                                        ...
                                        <a class="text-decoration-none text-danger" href="<?= base_url('admin/uploads/' . $l['id'] . '/delete') ?>"><i class="ti ti-trash" title="Delete"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
